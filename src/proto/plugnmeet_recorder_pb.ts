...
export class PlugNmeetToRecorder extends Message<PlugNmeetToRecorder> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "recorder_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 8, name: "access_token", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 9, name: "rtmp_url", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ]);
...
export class StartRecorderChildArgs extends Message<StartRecorderChildArgs> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 15, name: "xvfb_dpi", kind: "scalar", T: 13 /* ScalarType.UINT32 */, opt: true },
  ]);
